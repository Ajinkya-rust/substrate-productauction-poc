...
/// Used for the module template in `./productauction.rs`
mod productauction;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("productauction"),
	impl_name: create_runtime_str!("productauction"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
impl productauction::Trait for Runtime {
	//type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// ExampleModule: substrate_module_template::{Module, Call, Storage, Event<T>},
           Productauction: productauction::{Module, Call, Storage},
